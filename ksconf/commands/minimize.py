...
class MinimizeCmd(KsconfCmd):
    ...
    def register_args(self, parser):
        parser.add_argument("conf", metavar="CONF", nargs="+",
                            ...
                            help="The default configuration file(s) used to determine what base settings are. "
        ...
        parser.add_argument("--target", "-t", metavar="TARGET",
                            ...
                            help="The local file that you wish to remove duplicate settings from.  "
        ...
        grp1.add_argument("--output",
                          ...
                          default=None,
                          help="Write the minimized output to a separate file instead of updating TARGET."
                          ).completer = conf_files_completer
        parser.add_argument("--explode-default", "-E", default=False, action="store_true",
                            ...
                            "``btool list`` output.")
        parser.add_argument("-k", "--preserve-key", action="append", default=[],
