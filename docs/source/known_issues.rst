...
- File cleanup issues after *KSCONF app for Splunk* upgrades.  This can be causd by old `.dist-info`
  folders or other stale files left arround from between versions.  If you encounter this issue,
